...
internal class AnArbiter : SurvivorBase
{
	...
	internal override void InitializeCharacter()
	{
		...
		TargetTracker targetTracker = bodyPrefab.AddComponent<TargetTracker>();
		targetTracker.maxTrackingDistance = 40f;
	}

	internal override void InitializeUnlockables()
	{
		masterySkinUnlockableDef = Unlockables.AddUnlockable<ArbiterMasteryAchievement>(serverTracked: true);
	}

	internal override void InitializeDoppelganger()
	{
		Prefabs.CreateGenericDoppelganger(SurvivorBase.instance.bodyPrefab, bodyName + "MonsterMaster", "Mage");
	}
	...
	internal override void InitializeHitboxes()
	{
		...
		Transform hitboxTransform = componentInChildren.FindChild("FairyHitbox");
		Prefabs.SetupHitbox(gameObject, hitboxTransform, "Fairy");
	}
	...
	internal override void InitializeSkills()
	{
		...
		component.passiveSkill.skillNameToken = text + "_ARBITER_BODY_PASSIVE_NAME";
		component.passiveSkill.skillDescriptionToken = text + "_ARBITER_BODY_PASSIVE_DESCRIPTION";
		...
		Skills.AddPrimarySkill(bodyPrefab, Skills.CreatePrimarySkillDef(new SerializableEntityStateType(typeof(FairyCombo)), "Weapon", text + "_ARBITER_BODY_PRIMARY_FAIRY_NAME", text + "_ARBITER_BODY_PRIMARY_FAIRY_DESCRIPTION", Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterPrimaryIcon"), agile: false));
		SkillDefInfo skillDefInfo = new SkillDefInfo();
		skillDefInfo.skillName = text + "_ARBITER_BODY_SECONDARY_LOCK_NAME";
		skillDefInfo.skillNameToken = text + "_ARBITER_BODY_SECONDARY_LOCK_NAME";
		skillDefInfo.skillDescriptionToken = text + "_ARBITER_BODY_SECONDARY_LOCK_DESCRIPTION";
		skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSecondaryIcon");
		skillDefInfo.activationState = new SerializableEntityStateType(typeof(Lock));
		...
		skillDefInfo.keywordTokens = new string[1] { "KEYWORD_LOCK" };
		SkillDef val = Skills.CreateTrackerSkillDef(skillDefInfo);
		skillDefInfo = new SkillDefInfo();
		skillDefInfo.skillName = text + "_ARBITER_BODY_SECONDARY_UNLOCK_NAME";
		skillDefInfo.skillNameToken = text + "_ARBITER_BODY_SECONDARY_UNLOCK_NAME";
		skillDefInfo.skillDescriptionToken = text + "_ARBITER_BODY_SECONDARY_UNLOCK_DESCRIPTION";
		skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSecondaryTwoIcon");
		skillDefInfo.activationState = new SerializableEntityStateType(typeof(Unlock));
		skillDefInfo.activationStateMachineName = "Slide";
		skillDefInfo.baseMaxStock = 1;
		skillDefInfo.baseRechargeInterval = 25f;
		skillDefInfo.beginSkillCooldownOnSkillEnd = false;
		skillDefInfo.canceledFromSprinting = false;
		skillDefInfo.forceSprintDuringState = false;
		skillDefInfo.fullRestockOnAssign = true;
		...
		skillDefInfo.keywordTokens = new string[1] { "KEYWORD_UNLOCK" };
		Skills.unlockSkillDef = Skills.CreateTrackerSkillDef(skillDefInfo);
		Skills.AddSecondarySkills(bodyPrefab, val, Skills.unlockSkillDef);
		skillDefInfo = new SkillDefInfo();
		skillDefInfo.skillName = text + "_ARBITER_BODY_UTILITY_PILLARS_NAME";
		skillDefInfo.skillNameToken = text + "_ARBITER_BODY_UTILITY_PILLARS_NAME";
		skillDefInfo.skillDescriptionToken = text + "_ARBITER_BODY_UTILITY_PILLARS_DESCRIPTION";
		skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterUtilityIcon");
		skillDefInfo.activationState = new SerializableEntityStateType(typeof(ChannelPillar));
		...
		skillDefInfo = new SkillDefInfo();
		skillDefInfo.skillName = text + "_ARBITER_BODY_UTILITY_PILLARSSPEAR_NAME";
		skillDefInfo.skillNameToken = text + "_ARBITER_BODY_UTILITY_PILLARSSPEAR_NAME";
		skillDefInfo.skillDescriptionToken = text + "_ARBITER_BODY_UTILITY_PILLARSSPEAR_DESCRIPTION";
		skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterUtilityTwoIcon");
		skillDefInfo.activationState = new SerializableEntityStateType(typeof(ChargePillarSpear));
		skillDefInfo.activationStateMachineName = "Weapon";
		skillDefInfo.baseMaxStock = 1;
		...
		skillDefInfo.requiredStock = 1;
		skillDefInfo.stockToConsume = 1;
		skillDefInfo.keywordTokens = new string[1] { "KEYWORD_FAIRY" };
		SkillDef val3 = Skills.CreateSkillDef(skillDefInfo);
		Skills.AddUtilitySkills(bodyPrefab, val2, val3);
		skillDefInfo = new SkillDefInfo();
		skillDefInfo.skillName = text + "_ARBITER_BODY_SPECIAL_SHOCKWAVE_NAME";
		skillDefInfo.skillNameToken = text + "_ARBITER_BODY_SPECIAL_SHOCKWAVE_NAME";
		skillDefInfo.skillDescriptionToken = text + "_ARBITER_BODY_SPECIAL_SHOCKWAVE_DESCRIPTION";
		skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSpecialIcon");
		skillDefInfo.activationState = new SerializableEntityStateType(typeof(ChannelShockwave));
		skillDefInfo.activationStateMachineName = "Weapon";
		...
		skillDefInfo.keywordTokens = new string[1] { "KEYWORD_FEEBLE" };
	...
	internal override void InitializeSkins()
	{
		...
		SkinDef val2 = Skins.CreateSkinDef("COF_ARBITER_BODY_DEFAULT_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterMainSkin"), baseRendererInfos, mainSkinnedMeshRenderer, gameObject);
		...
		array[0].defaultMaterial = Assets.CreateMaterial("matSkinTwo", 0.8f, new Color(1f, 2.40566039f, 0f));
		SkinDef val3 = Skins.CreateSkinDef("COF_ARBITER_BODY_SECOND_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSecondSkin"), array, mainSkinnedMeshRenderer, gameObject);
		...
		list.Add(val3);
		RendererInfo[] array2 = (RendererInfo[])(object)new RendererInfo[baseRendererInfos.Length];
		baseRendererInfos.CopyTo(array2, 0);
		array2[0].defaultMaterial = Assets.CreateMaterial("matSkinThree", 0.8f, new Color(3.109756f, 3.109756f, 3.109756f));
		SkinDef val4 = Skins.CreateSkinDef("COF_ARBITER_BODY_THIRD_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterThirdSkin"), array2, mainSkinnedMeshRenderer, gameObject);
		val4.meshReplacements = (MeshReplacement[])(object)new MeshReplacement[1]
		{
			new MeshReplacement
			{
				mesh = Assets.mainAssetBundle.LoadAsset<Mesh>("meshArbiter"),
		...
		list.Add(val4);
		RendererInfo[] array3 = (RendererInfo[])(object)new RendererInfo[baseRendererInfos.Length];
		baseRendererInfos.CopyTo(array3, 0);
		array3[0].defaultMaterial = Assets.CreateMaterial("matArbiterMastery", 1f, Color.yellow, 1f);
		SkinDef val5 = Skins.CreateSkinDef("COF_ARBITER_BODY_MASTERY_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterMasterySkin"), array3, mainSkinnedMeshRenderer, gameObject, masterySkinUnlockableDef);
		val5.meshReplacements = (MeshReplacement[])(object)new MeshReplacement[1]
		{
			new MeshReplacement
			{
	...
	private void SetupScepterDisplay()
	{
		...
		itemDisplayRules.Add(new KeyAssetRuleGroup
		{
			keyAsset = (UnityEngine.Object)(object)ItemBase<AncientScepterItem>.instance.ItemDef,
			displayRuleGroup = new DisplayRuleGroup
			{
				rules = (ItemDisplayRule[])(object)new ItemDisplayRule[1]
				{
