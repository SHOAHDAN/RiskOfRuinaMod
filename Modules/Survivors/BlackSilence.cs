...
// Type: RiskOfRuinaMod.Modules.Survivors.BlackSilence
...
namespace RiskOfRuinaMod.Modules.Survivors
{
  internal class BlackSilence : SurvivorBase
  {
    ...
    internal override string bodyName { get; set; } = nameof (BlackSilence);
    ...
    internal override CustomRendererInfo[] customRendererInfos { get; set; } = new CustomRendererInfo[4]
    {
      new CustomRendererInfo()
      {
        ...
        material = BlackSilence.coatMat
      },
      new CustomRendererInfo()
      {
        childName = "CoatEGO",
        material = BlackSilence.coatEGOMat
      },
      new CustomRendererInfo()
      {
        childName = "Mimicry",
        material = BlackSilence.mimicryMat
      },
      new CustomRendererInfo()
      {
        childName = "Model",
        material = BlackSilence.redMistMat
      }
    };
    ...
    internal override void InitializeCharacter()
    {
      ...
      BlackSilence.blackSilencePrefab = this.bodyPrefab;
    ...
    internal override void InitializeUnlockables() => BlackSilence.masterySkinUnlockableDef = Unlockables.AddUnlockable<RedMistMasteryAchievement>(true);
    ...
    internal override void InitializeSkills()
    {
      ...
      BlackSilence.InitializeSkills(this.bodyPrefab, "COF");
    }
    ...
    public static void InitializeSkills(GameObject bodyPrefab, string prefix)
    {
      ...
      BlackSilence.BasicAttack = RiskOfRuinaMod.Modules.Skills.CreatePrimarySkillDef(new SerializableEntityStateType(typeof (BasicStringStart)), "Body", prefix + "_REDMIST_BODY_PRIMARY_LEVELSLASH_NAME", prefix + "_REDMIST_BODY_PRIMARY_LEVELSLASH_DESCRIPTION", Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistPrimaryIcon"), false);
      RiskOfRuinaMod.Modules.Skills.AddPrimarySkill(bodyPrefab, BlackSilence.BasicAttack);
      ...
      BlackSilence.NormalDodge = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
      ...
      BlackSilence.NormalBlock = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
      ...
      RiskOfRuinaMod.Modules.Skills.AddUtilitySkills(bodyPrefab, BlackSilence.NormalDodge, BlackSilence.NormalBlock);
      BlackSilence.EGODodge = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        skillName = prefix + "_REDMIST_BODY_UTILITY_DODGE_NAME",
        skillNameToken = prefix + "_REDMIST_BODY_UTILITY_DODGE_NAME",
        skillDescriptionToken = prefix + "_REDMIST_BODY_UTILITY_DODGE_DESCRIPTION",
      ...
      RiskOfRuinaMod.Modules.Skills.skillDefs.Add(BlackSilence.EGODodge);
      BlackSilence.EGOBlock = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        skillName = prefix + "_REDMIST_BODY_UTILITY_BLOCK_NAME",
        skillNameToken = prefix + "_REDMIST_BODY_UTILITY_BLOCK_NAME",
        skillDescriptionToken = prefix + "_REDMIST_BODY_UTILITY_BLOCK_DESCRIPTION",
      ...
      RiskOfRuinaMod.Modules.Skills.skillDefs.Add(BlackSilence.NormalBlock);
      BlackSilence.EGOActivate = RiskOfRuinaMod.Modules.Skills.CreateEGOSkillDef(new SkillDefInfo()
      {
      ...
      RiskOfRuinaMod.Modules.Skills.AddSpecialSkills(bodyPrefab, BlackSilence.EGOActivate);
      BlackSilence.HorizontalSlash = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
      ...
      RiskOfRuinaMod.Modules.Skills.skillDefs.Add(BlackSilence.HorizontalSlash);
    }
    ...
    internal override void InitializeSkins()
    {
      ...
      SkinDef skinDef2 = Skins.CreateSkinDef("COF_REDMIST_BODY_MASTERY_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistSecondSkin"), rendererInfos, skinnedMeshRenderer, gameObject, BlackSilence.masterySkinUnlockableDef);
