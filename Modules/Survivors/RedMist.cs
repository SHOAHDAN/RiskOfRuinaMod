...
// Type: RiskOfRuinaMod.Modules.Survivors.RedMist
...
namespace RiskOfRuinaMod.Modules.Survivors
{
  internal class RedMist : SurvivorBase
  {
    ...
    internal static Material mimicryMat = Assets.CreateMaterial("matMimicry", 0.0f, Color.white, 1f);
    internal static Material coatMat = Assets.CreateMaterial("matCoat", 0.0f, Color.white, 1f);
    internal static Material coatEGOMat = Assets.mainAssetBundle.LoadAsset<Material>("matCoatEGO");
    private static UnlockableDef masterySkinUnlockableDef;

    internal override string bodyName { get; set; } = nameof (RedMist);
    ...
    internal override BodyInfo bodyInfo { get; set; } = new BodyInfo()
    {
      ...
      bodyNameToken = "COF_REDMIST_BODY_NAME",
      bodyColor = Color.red,
      characterPortrait = Assets.LoadCharacterIcon(nameof (RedMist)),
      ...
      jumpCount = 1,
      maxHealth = 110f,
      subtitleNameToken = "COF_REDMIST_BODY_SUBTITLE",
    ...
    internal override CustomRendererInfo[] customRendererInfos { get; set; } = new CustomRendererInfo[4]
    {
      new CustomRendererInfo()
      {
        ...
        material = RedMist.coatMat
      },
      new CustomRendererInfo()
      {
        childName = "CoatEGO",
        material = RedMist.coatEGOMat
      },
      new CustomRendererInfo()
      {
        childName = "Mimicry",
        material = RedMist.mimicryMat
      },
      new CustomRendererInfo()
      {
        childName = "Model",
        material = RedMist.redMistMat
      }
    };
    ...
    internal override void InitializeCharacter()
    {
      ...
      {
        RedMist.coatEGOMat = Assets.CreateMaterial("matCoatEGO", 0.0f, Color.red, 1f);
        this.customRendererInfos = new CustomRendererInfo[4]
        {
          new CustomRendererInfo()
          {
            childName = "CoatNormal",
      ...
      RedMist.redMistPrefab = this.bodyPrefab;
      this.bodyPrefab.AddComponent<TargetTracker>();
      this.bodyPrefab.AddComponent<RedMistEmotionComponent>();
      this.bodyPrefab.AddComponent<RedMistStatTracker>();
      // ISSUE: method pointer
      HUD.Awake += new HUD.hook_Awake((object) null, __methodptr(HUDAwake));
    }

    internal override void InitializeUnlockables() => RedMist.masterySkinUnlockableDef = Unlockables.AddUnlockable<RedMistMasteryAchievement>(true);

    internal override void InitializeDoppelganger() => Prefabs.CreateGenericDoppelganger(SurvivorBase.instance.bodyPrefab, this.bodyName + "MonsterMaster", "Loader");
    ...
    internal override void InitializeHitboxes()
    {
      ...
      Transform child1 = componentInChildren.FindChild("BasicHitbox");
      Prefabs.SetupHitbox(gameObject, child1, "Basic");
      Transform child2 = componentInChildren.FindChild("BasicThirdHitbox");
      Prefabs.SetupHitbox(gameObject, child2, "BasicThird");
      Transform child3 = componentInChildren.FindChild("ForwardHitbox");
      Prefabs.SetupHitbox(gameObject, child3, "Forward");
      Transform child4 = componentInChildren.FindChild("BackHitbox");
      Prefabs.SetupHitbox(gameObject, child4, "Back");
      Transform child5 = componentInChildren.FindChild("JumpHitbox");
      Prefabs.SetupHitbox(gameObject, child5, "Jump");
      Transform child6 = componentInChildren.FindChild("SideHitbox");
      Prefabs.SetupHitbox(gameObject, child6, "Side");
      Transform child7 = componentInChildren.FindChild("AirBasicHitbox");
      Prefabs.SetupHitbox(gameObject, child7, "AirBasic");
      Transform child8 = componentInChildren.FindChild("BlockCounterHitbox");
      Prefabs.SetupHitbox(gameObject, child8, "BlockCounter");
      Transform child9 = componentInChildren.FindChild("EGOBasicHitbox");
      Prefabs.SetupHitbox(gameObject, child9, "EGOBasic");
      Transform child10 = componentInChildren.FindChild("EGOBasicThirdHitbox");
      Prefabs.SetupHitbox(gameObject, child10, "EGOBasicThird");
      Transform child11 = componentInChildren.FindChild("EGOForwardHitbox");
      Prefabs.SetupHitbox(gameObject, child11, "EGOForward");
      Transform child12 = componentInChildren.FindChild("EGOBackHitbox");
      Prefabs.SetupHitbox(gameObject, child12, "EGOBack");
      Transform child13 = componentInChildren.FindChild("EGOSideHitbox");
      Prefabs.SetupHitbox(gameObject, child13, "EGOSide");
      Transform child14 = componentInChildren.FindChild("EGOJumpHitbox");
      Prefabs.SetupHitbox(gameObject, child14, "EGOJump");
      Transform child15 = componentInChildren.FindChild("EGOAirBasicHitbox");
      Prefabs.SetupHitbox(gameObject, child15, "EGOAirBasic");
      Transform child16 = componentInChildren.FindChild("HorizontalHitbox");
      Prefabs.SetupHitbox(gameObject, child16, "Horizontal");
    }

    internal override void InitializeSkills()
    {
      RiskOfRuinaMod.Modules.Skills.CreateSkillFamilies(this.bodyPrefab);
      RedMist.InitializeSkills(this.bodyPrefab, "COF");
    }
    ...
    public static void InitializeSkills(GameObject bodyPrefab, string prefix)
    {
      ...
      RedMist.BasicAttack = RiskOfRuinaMod.Modules.Skills.CreatePrimarySkillDef(new SerializableEntityStateType(typeof (BasicStringStart)), "Body", prefix + "_REDMIST_BODY_PRIMARY_LEVELSLASH_NAME", prefix + "_REDMIST_BODY_PRIMARY_LEVELSLASH_DESCRIPTION", Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistPrimaryIcon"), false);
      RiskOfRuinaMod.Modules.Skills.AddPrimarySkill(bodyPrefab, RedMist.BasicAttack);
      SkillDef trackerSkillDef = RiskOfRuinaMod.Modules.Skills.CreateTrackerSkillDef(new SkillDefInfo()
      {
        ...
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistSecondaryIcon"),
        activationState = new SerializableEntityStateType(typeof (Onrush)),
      ...
      RiskOfRuinaMod.Modules.Skills.AddSecondarySkills(bodyPrefab, trackerSkillDef);
      RedMist.NormalDodge = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        ...
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistUtilityIcon"),
        activationState = new SerializableEntityStateType(typeof (Dodge)),
        activationStateMachineName = "Body",
        baseMaxStock = 1,
      ...
      RedMist.NormalBlock = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        ...
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistUtilityTwoIcon"),
        activationState = new SerializableEntityStateType(typeof (Block)),
        activationStateMachineName = "Body",
        baseMaxStock = 1,
        baseRechargeInterval = 0.0f,
        beginSkillCooldownOnSkillEnd = false,
      ...
      RiskOfRuinaMod.Modules.Skills.AddUtilitySkills(bodyPrefab, RedMist.NormalDodge, RedMist.NormalBlock);
      RedMist.EGODodge = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        skillName = prefix + "_REDMIST_BODY_UTILITY_DODGE_NAME",
        skillNameToken = prefix + "_REDMIST_BODY_UTILITY_DODGE_NAME",
        skillDescriptionToken = prefix + "_REDMIST_BODY_UTILITY_DODGE_DESCRIPTION",
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistUtilityIcon"),
        activationState = new SerializableEntityStateType(typeof (RiskOfRuinaMod.SkillStates.EGODodge)),
      ...
      RiskOfRuinaMod.Modules.Skills.skillDefs.Add(RedMist.EGODodge);
      RedMist.EGOBlock = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        skillName = prefix + "_REDMIST_BODY_UTILITY_BLOCK_NAME",
        skillNameToken = prefix + "_REDMIST_BODY_UTILITY_BLOCK_NAME",
        skillDescriptionToken = prefix + "_REDMIST_BODY_UTILITY_BLOCK_DESCRIPTION",
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistUtilityTwoIcon"),
        activationState = new SerializableEntityStateType(typeof (RiskOfRuinaMod.SkillStates.EGOBlock)),
        activationStateMachineName = "Slide",
        baseMaxStock = 1,
        baseRechargeInterval = 0.0f,
        beginSkillCooldownOnSkillEnd = false,
      ...
      RiskOfRuinaMod.Modules.Skills.skillDefs.Add(RedMist.NormalBlock);
      RedMist.EGOActivate = RiskOfRuinaMod.Modules.Skills.CreateEGOSkillDef(new SkillDefInfo()
      {
        ...
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistSpecialIcon"),
        activationState = new SerializableEntityStateType(typeof (RiskOfRuinaMod.SkillStates.EGOActivate)),
        activationStateMachineName = "Body",
        baseMaxStock = 1,
        baseRechargeInterval = 0.0f,
        beginSkillCooldownOnSkillEnd = false,
        ...
        requiredStock = 0,
        stockToConsume = 0,
        keywordTokens = new string[1]{ "KEYWORD_EGO" }
      });
      RiskOfRuinaMod.Modules.Skills.AddSpecialSkills(bodyPrefab, RedMist.EGOActivate);
      RedMist.HorizontalSlash = RiskOfRuinaMod.Modules.Skills.CreateSkillDef(new SkillDefInfo()
      {
        ...
        skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistSpecialTwoIcon"),
        activationState = new SerializableEntityStateType(typeof (EGOHorizontal)),
        activationStateMachineName = "Body",
        baseMaxStock = 1,
      ...
      RiskOfRuinaMod.Modules.Skills.skillDefs.Add(RedMist.HorizontalSlash);
    }
    ...
    internal override void InitializeSkins()
    {
      ...
      SkinDef skinDef1 = Skins.CreateSkinDef("COF_REDMIST_BODY_DEFAULT_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistMainSkin"), baseRendererInfos, skinnedMeshRenderer, gameObject);
      skinDef1.meshReplacements = new SkinDef.MeshReplacement[4]
      {
      ...
      CharacterModel.RendererInfo[] rendererInfos = new CharacterModel.RendererInfo[baseRendererInfos.Length];
      baseRendererInfos.CopyTo((Array) rendererInfos, 0);
      rendererInfos[0].defaultMaterial = Assets.CreateMaterial("matArgaliaCoat", 0.0f, Color.white, 1f);
      rendererInfos[1].defaultMaterial = Assets.CreateMaterial("matArgaliaCoat", 0.0f, Color.white, 1f);
      rendererInfos[2].defaultMaterial = Assets.CreateMaterial("matVibrato", 0.9f, new Color(0.0f, 0.95f, 1f), 1f);
      rendererInfos[3].defaultMaterial = Assets.CreateMaterial("matArgalia", 0.9f, new Color(0.0f, 0.95f, 1f), 1f);
      SkinDef skinDef2 = Skins.CreateSkinDef("COF_REDMIST_BODY_MASTERY_SKIN_NAME", Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistSecondSkin"), rendererInfos, skinnedMeshRenderer, gameObject, RedMist.masterySkinUnlockableDef);
      skinDef2.meshReplacements = new SkinDef.MeshReplacement[4]
      {
        new SkinDef.MeshReplacement()
        {
    ...
    {
      orig.Invoke(self);
      EmotionHUD emotionHud = ((Component) self).gameObject.AddComponent<EmotionHUD>();
      GameObject gameObject = Object.Instantiate<GameObject>(Assets.mainAssetBundle.LoadAsset<GameObject>("EmotionGauge"), ((Component) self).transform.Find("MainContainer").Find("MainUIArea").Find("SpringCanvas").Find("BottomLeftCluster"));
      ((Transform) gameObject.GetComponent<RectTransform>()).localPosition = Vector3.zero;
      ((Transform) gameObject.GetComponent<RectTransform>()).localScale = Vector3.one;
      gameObject.GetComponent<RectTransform>().anchorMin = new Vector2(0.0f, 0.0f);
      ...
      gameObject.GetComponent<RectTransform>().anchoredPosition = new Vector2(0.0f, -55f);
      emotionHud.emotionGauge = gameObject;
      emotionHud.emotionFill = ((Component) gameObject.transform.Find("GaugeFill")).gameObject.GetComponent<Image>();
    }
    ...
    internal override void SetItemDisplays()
    {
      ...
      (^ref displayRuleGroup93).rules = new ItemDisplayRule[1]
      {
        new ItemDisplayRule()
        {
          ...
          childName = "Head",
          localPos = new Vector3(0.0f, 0.21324f, 0.06803f),
