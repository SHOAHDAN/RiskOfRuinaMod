...
// Type: RiskOfRuinaMod.Modules.Achievements.BlackSilenceMasteryAchievement
...
namespace RiskOfRuinaMod.Modules.Achievements
{
  internal class BlackSilenceMasteryAchievement : ModdedUnlockable
  {
    ...
    {
      (object) Language.GetString("COF_BLACKSILENCE_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_NAME"),
      (object) Language.GetString("COF_BLACKSILENCE_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_DESC")
    }));
    ...
    public override BodyIndex LookUpRequiredBodyIndex() => BodyCatalog.FindBodyIndex(SurvivorBase.instance.fullBodyName);
