...
namespace RiskOfRuinaMod.SkillStates
{
	...
	internal class ForwardAttack : BaseDirectionalSkill
	{
		public override void OnEnter()
		{
			...
			impactSound = Assets.swordHitSoundStab.get_index();
			switch (attackIndex)
			{
				case 1:
					muzzleString = "Spear1";
			...
			base.OnEnter();
			swingEffectPrefab = statTracker.piercePrefab;
		}
		...
		protected override void PlayAttackAnimation()
		{
			if (attackIndex >= 2)
			{
				((EntityState)this).PlayCrossfade("FullBody, Override", "ForwardSpear" + attackIndex, "BaseAttack.playbackRate", duration, 0.01f);
			}
			else
			{
				((EntityState)this).PlayCrossfade("FullBody, Override", "ForwardSpear1", "BaseAttack.playbackRate", duration, 0.1f);
			}
		}
