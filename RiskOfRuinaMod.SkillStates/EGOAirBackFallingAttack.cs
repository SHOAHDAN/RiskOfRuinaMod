...
internal class EGOAirBackFallingAttack : BaseSkillState
{
	...
	public override void OnEnter()
	{
		...
		((EntityState)this).PlayCrossfade("FullBody, Override", "EGOAirBackSlashContinue", "BaseAttack.playbackRate", duration, 0.1f);
	}
	...
	public override void FixedUpdate()
	{
		...
		if (((EntityState)this).get_fixedAge() >= duration || ((EntityState)this).get_characterMotor().get_isGrounded())
		{
			...
			((EntityState)this).PlayCrossfade("FullBody, Override", "EGOAirBackSlashFinish", "BaseAttack.playbackRate", cooldown, 0.1f);
			landed = true;
			...
			if (((EntityState)this).get_isAuthority())
			{
				...
				val.scale = 1f;
				EffectManager.SpawnEffect(((EntityState)this).GetComponent<RedMistStatTracker>().groundPoundEffect, val, false);
