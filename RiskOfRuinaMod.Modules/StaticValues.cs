namespace RiskOfRuinaMod.Modules
{
	...
	{
		internal const float originalMoveSpeed = 10f;
		...
		internal const float forwardAttackComboDamageCoefficient = 1f;

		internal const float airBasicAttackDamageCoefficient = 2f;

		internal const float airBackAttackDamageCoefficient = 2f;

		internal const float airBackSlamAttackDamageCoefficient = 2f;

		internal const float onrushDamageCoefficient = 4f;

		internal const float horizontalDamageCoefficient = 20f;
		...
		internal const float fairyDebuffCoefficient = 1f;

		internal const float fairyDamageCoefficient = 0.75f;

		internal const float lockDamageCoefficient = 3f;
		...
		internal const float pillarDamageCoefficient = 5f;

		internal const float pillarSpearRadius = 15f;

		internal const float pillarSpearChargeDuration = 2f;

		internal const float pillarSpearMinDamageCoefficient = 3f;

		internal const float pillarSpearMaxDamageCoefficient = 6f;
	}
}