...
// Type: RiskOfRuinaMod.SkillStates.ChannelPillar
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class ChannelPillar : BaseChannelSpellState
  {
    ...
    protected override BaseCastChanneledSpellState GetNextState() => (BaseCastChanneledSpellState) new CastPillar();
  }
}
