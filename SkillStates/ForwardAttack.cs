...
// Type: RiskOfRuinaMod.SkillStates.ForwardAttack
...
{
  internal class ForwardAttack : BaseDirectionalSkill
  {
    public override void OnEnter()
    {
      ...
      this.impactSound = Assets.swordHitSoundStab.index;
      switch (this.attackIndex)
      {
        case 1:
          ...
          break;
        case 2:
          this.muzzleString = "Spear2";
          break;
        case 3:
          this.muzzleString = "Spear3";
          break;
        case 4:
          this.muzzleString = "Spear4";
          break;
      }
      ...
      base.OnEnter();
      this.swingEffectPrefab = this.statTracker.piercePrefab;
    }

    protected override void PlayAttackAnimation()
    {
      if (this.attackIndex >= 2)
        ((EntityState) this).PlayCrossfade("FullBody, Override", "ForwardSpear" + this.attackIndex.ToString(), "BaseAttack.playbackRate", this.duration, 0.01f);
      else
        ((EntityState) this).PlayCrossfade("FullBody, Override", "ForwardSpear1", "BaseAttack.playbackRate", this.duration, 0.1f);
    }
