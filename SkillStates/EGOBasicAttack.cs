...
// Type: RiskOfRuinaMod.SkillStates.EGOBasicAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class EGOBasicAttack : BaseDirectionalSkill
  {
    ...
    protected override void PlayAttackAnimation() => ((EntityState) this).PlayCrossfade("FullBody, Override", "EGOBasicSlash" + this.attackIndex.ToString(), "BaseAttack.playbackRate", this.duration, 0.1f);
