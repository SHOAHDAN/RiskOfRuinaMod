...
// Type: RiskOfRuinaMod.SkillStates.JumpRisingAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class JumpRisingAttack : BaseSkillState
  {
    ...
    protected void PlayAttackAnimation() => ((EntityState) this).PlayCrossfade("FullBody, Override", "JumpSlashContinue", "BaseAttack.playbackRate", this.duration, 0.1f);
