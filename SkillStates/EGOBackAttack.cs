...
// Type: RiskOfRuinaMod.SkillStates.EGOBackAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class EGOBackAttack : BaseDirectionalSkill
  {
    ...
    protected override void PlayAttackAnimation() => ((EntityState) this).PlayCrossfade("FullBody, Override", "EGOBackSlash", "BaseAttack.playbackRate", this.duration, 0.1f);
