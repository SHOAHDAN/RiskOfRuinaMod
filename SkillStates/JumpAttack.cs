...
// Type: RiskOfRuinaMod.SkillStates.JumpAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class JumpAttack : BaseDirectionalSkill
  {
    ...
    protected override void PlayAttackAnimation() => ((EntityState) this).PlayCrossfade("FullBody, Override", "JumpSlash", "BaseAttack.playbackRate", this.duration, 0.1f);
    ...
    protected override void FireAttack()
    {
      ...
      if (!((EntityState) this).inputBank.skill1.down || !((EntityState) this).inputBank.jump.down)
        return;
      ((EntityState) this).outer.SetNextState((EntityState) new JumpRisingAttack()
      {
