...
// Type: RiskOfRuinaMod.SkillStates.EGOAirBasicAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class EGOAirBasicAttack : BaseDirectionalSkill
  {
    ...
    protected override void PlayAttackAnimation() => ((EntityState) this).PlayCrossfade("FullBody, Override", "EGOAirBasicSlash" + this.attackIndex.ToString(), "BaseAttack.playbackRate", this.duration, 0.1f);
