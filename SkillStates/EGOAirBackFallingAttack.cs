...
// Type: RiskOfRuinaMod.SkillStates.EGOAirBackFallingAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class EGOAirBackFallingAttack : BaseSkillState
  {
    ...
    public virtual void OnEnter()
    {
      ...
      ((EntityState) this).PlayCrossfade("FullBody, Override", "EGOAirBackSlashContinue", "BaseAttack.playbackRate", this.duration, 0.1f);
    }
    ...
    public virtual void FixedUpdate()
    {
      ...
      else
      {
        ...
        if ((double) ((EntityState) this).fixedAge >= (double) this.duration || ((EntityState) this).characterMotor.isGrounded)
        {
          ...
          ((EntityState) this).PlayCrossfade("FullBody, Override", "EGOAirBackSlashFinish", "BaseAttack.playbackRate", this.cooldown, 0.1f);
          this.landed = true;
