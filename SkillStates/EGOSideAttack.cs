...
// Type: RiskOfRuinaMod.SkillStates.EGOSideAttack
...
namespace RiskOfRuinaMod.SkillStates
{
  internal class EGOSideAttack : BaseDirectionalSkill
  {
    ...
    public override void OnEnter()
    {
      ...
      this.impactSound = Assets.swordHitEGOSoundHori.index;
    ...
    protected override void PlayAttackAnimation() => ((EntityState) this).PlayCrossfade("FullBody, Override", "EGOSideSlash" + this.attackIndex.ToString(), "BaseAttack.playbackRate", this.duration, 0.1f);
    ...
    public override void FixedUpdate()
    {
      ...
      float num = Mathf.Clamp(0.0f, 3.5f, 0.5f * this.trueMoveSpeed);
